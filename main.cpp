...
public:
	...
	Laborator(){
		...
		view_matrix_normal = glm::lookAt(glm::vec3(0,50,300), glm::vec3(0,10,0), glm::vec3(0,-1, 1));
        view_matrix_reflectiv = glm::lookAt(glm::vec3(0, 20, -60), glm::vec3(0, 10, 0), glm::vec3(0, -1, 1));
	...
	void notifyDisplayFrame(){
        ...
        //TODO
		int mirror_width = framebuffer.GetWidth();
		int mirror_height = framebuffer.GetHeight();
		...
		glUniformMatrix4fv(glGetUniformLocation(gl_program_shader, "view_matrix"), 1, false, glm::value_ptr(view_matrix_reflectiv));
        ...
        if (toggle_quad_texture){
            //TODO
			//setam textura la cea din framebuffer
			quad_texture = framebuffer.getColorTexture();
